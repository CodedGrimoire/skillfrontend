...
export const GraduationCapIcon = ({ className = "h-6 w-6" }: { className?: string }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
  ...
  >
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M12 14v7M5 12.55v-1.1a12.08 12.08 0 017-1.9M19 12.55v-1.1a12.08 12.08 0 00-7-1.9"
    />
  </svg>
);
...
export const HandshakeIcon = ({ className = "h-6 w-6" }: { className?: string }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const LightbulbIcon = ({ className = "h-6 w-6" }: { className?: string }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const PhoneIcon = ({ className = "h-5 w-5" }: { className?: string }) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M3 5a2 2 0 012-2h2l2 5-2.5 2.5a13 13 0 006 6L15 14l5 2v2a2 2 0 01-2 2h-1C9.82 20 4 14.18 4 7V6a2 2 0 012-2"
    />
  </svg>
);
